...
print("\n--- Model Validation ---")
print(f"Bagging Accuracy (on validation set): {accuracy_score(y_val, bag_clf.predict(X_val)):.4f}")
print(f"Random Forest Accuracy (on validation set): {accuracy_score(y_val, rf_clf.predict(X_val)):.4f}")


print("\nRetraining final model (Random Forest) on full training data...")
...
test_predictions = rf_clf_final.predict(X_submission_test)
# --------------------------------------------------------
